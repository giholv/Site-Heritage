...
const CATEGORY_BUCKET = "category-images"; // <<< TROQUE se o bucket for outro (ou use o mesmo do produto)
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const { data, error } = await supabase
        .from("category_tree")
        .select("id,name,slug,cover_image_path,position,active")
        .eq("active", true)
        ...
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-3 text-sm text-black/55">
              Escolha uma categoria e veja todas as peças disponíveis.
            </p>
          </div>
